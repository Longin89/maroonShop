...
class H
{
    ...
    public static function currentPage()
    {
        ...
        if ($currentPage == PROOT || $currentPage == PROOT . strtolower(DEFAULT_CONTROLLER) . 'home/index') {
    ...
    foreach($menu as $key => $val):
      ...
      if(is_array($val)): ?>
        <li class="nav-item dropdown">
          <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?=$key?></a>
