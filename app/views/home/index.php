          ...
          <div class="natural__container container">
            <ul class="natural__list">
              <li class="natural list-item">
                <img src="https://api.s3.ragnyr.ru/shortly/maroon/images/for_face.jpg" alt="cosmetics for face">
              ...
              <li class="natural list-item">
                <img src="https://api.s3.ragnyr.ru/shortly/maroon/images/for_body.jpg" alt="cosmetics for body">
              ...
              <div class="bestsellers__slider-wrapper splide__track">
                ...
                <?php foreach($this->products as $product):?>
                  <li class="bestsellers__slider-item splide__slide slide-one">
                    <img src="<?=PROOT.$product->url;?>" alt="<?-$product->title;?>">
                    <a href="<?=PROOT?>catalog/details/<?=$product->id;?>">
                    ...
                    <a href="<?=PROOT?>catalog/details/<?=$product->id;?>" class="bestsellers__slider-link">
                      Подробнее
                    </a>
                  </li>
                  <?php endforeach;?>
